package hadoop.ch09.d17124080208;
...
public class ZooKeeperTest {
    ...
    public static void listener() throws IOException, KeeperException, InterruptedException{
        ...
        zk.exists("/stu17124080208", new Watcher(){
    ...
    private static void operate() throws IOException, KeeperException, InterruptedException {
        ...
        if(zk.exists("/stu17124080208", false) != null){
            zk.delete("/stu17124080208", -1);
        }
        // 创建一个目录节点
        zk.create("/stu17124080208", "adan".getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.PERSISTENT);
...
//		System.out.println(zk.getChildren("/testRootPath", true));
        ...
        // 修改目录节点数据
       zk.setData("/stu17124080208", "208".getBytes(), -1);
       System.out.println("目录节点状态：[" + zk.exists("/stu17124080208", true) + "]");
